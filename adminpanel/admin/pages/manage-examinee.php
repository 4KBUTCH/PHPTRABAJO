            ...
            <div class="app-page-title">
                <div class="page-title-wrapper">
                    <div class="page-title-heading">
                        <div>Administar Estudiantes</div>
                    </div>
                </div>
            </div>        
                            ...
                            <tbody>
                              <?php 
                                ...
                                if($selExmne->rowCount() > 0)
                                {
                                    while ($selExmneRow = $selExmne->fetch(PDO::FETCH_ASSOC)) { ?>
                                        <tr>
                                           ...
                                           <td>
                                               <a rel="facebox" href="facebox_modal/updateExaminee.php?id=<?php echo $selExmneRow['exmne_id']; ?>" class="btn btn-sm btn-primary">Editar</a>
                                ...
                                { ?>
                                    <tr>
                                      <td colspan="2">
                                        <h3 class="p-3">No Hay Estudiantes</h3>
                                      </td>
                                    </tr>
                                <?php }
                               ?>
