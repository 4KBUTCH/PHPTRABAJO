                   ...
                   <div class="app-page-title">
                    <div class="page-title-wrapper">
                        <div class="page-title-heading">
                            <div><b class="text-primary">Resultados Por Grado</b><br>
                                Nombre De Examen : <?php echo $selEx['ex_title']; ?><br><br>
                               <span class="border" style="padding:10px;color:black;background-color: yellow;">Excelente</span>
                               <span class="border" style="padding:10px;color:white;background-color: green;">Muy Bueno</span>
                               <span class="border" style="padding:10px;color:white;background-color: blue;">Basico</span>
                               <span class="border" style="padding:10px;color:white;background-color: red;">Bajo</span>
                               <span class="border" style="padding:10px;color:black;background-color: #E9ECEE;">No Hay Resultados</span>
                            </div>
                        </div>
                    </div>
                    </div>
                    <div class="table-responsive">
                        <table class="align-middle mb-0 table table-borderless table-striped table-hover" id="tableList">
                          <tbody>
                            <thead>
                                <tr>
                                    <th width="25%">Nombres Del Estudiante</th>
                                    <th>Score / Over</th>
                                    <th>Porcentaje</th>
                                </tr>
                            </thead>
                            ...
                            <tbody>
                              <?php 
                                ...
                                { ?>
                                    <tr>
                                      <td colspan="5">
                                        <h3 class="p-3">No Hay Examenes Realizados</h3>
                                      </td>
                                    </tr>
                                <?php }
                               ?>
