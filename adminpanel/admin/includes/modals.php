          ...
          <div class="form-group">
            ...
            <select class="form-control" name="courseSelected">
              ...
              <?php 
                ...
                { ?>
                  <option value="0">No Hay Grados</option>
                <?php }
               ?>
            </select>
          </div>
...
<div class="modal fade" id="modalForAddExaminee" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
   <form class="refreshFrm" id="addExamineeFrm" method="post">
     <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Agregar Estudiantes</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
        ...
        <div class="col-md-12">
          ...
          <div class="form-group">
            ...
            <select class="form-control" name="year_level" id="year_level">
              ...
              <option value="first year">Seccion Primaria</option>
              <option value="second year">Seccion Secundaria</option>
            </select>
          </div>
          <div class="form-group">
            <label>Email</label>
            <input type="email" name="email" id="email" class="form-control" placeholder="Cree Email" autocomplete="off" required="">
          </div>
          <div class="form-group">
            <label>Contraseña</label>
            <input type="password" name="password" id="password" class="form-control" placeholder="Cree Contraseña" autocomplete="off" required="">
          </div>
        </div>
      </div>
      <div class="modal-footer">
...
<div class="modal fade" id="modalForAddQuestion" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
   <form class="refreshFrm" id="addQuestionFrm" method="post">
     <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Agregar Pregunta for <br><?php echo $selExamRow['ex_title']; ?></h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
        ...
        <div class="col-md-12">
          ...
          <fieldset>
            ...
            <div class="form-group">
                ...
                <input type="" name="choice_A" id="choice_A" class="form-control" placeholder="Digite" autocomplete="off">
            </div>

            <div class="form-group">
                <label>Opcion B</label>
                <input type="" name="choice_B" id="choice_B" class="form-control" placeholder="Digite" autocomplete="off">
            </div>

            <div class="form-group">
                <label>Opcion C</label>
                <input type="" name="choice_C" id="choice_C" class="form-control" placeholder="Digite" autocomplete="off">
            </div>

            <div class="form-group">
                <label>Opcion D</label>
                <input type="" name="choice_D" id="choice_D" class="form-control" placeholder="Digite" autocomplete="off">
            </div>

            <div class="form-group">
                <label>Respuesta</label>
                <input type="" name="correctAnswer" id="" class="form-control" placeholder="Digite Respuesta Correcta" autocomplete="off">
            </div>
          </fieldset>
        </div>
      </div>
