			...
			<div class="wrap-login100">
				...
				<form method="post" id="adminLoginFrm" class="login100-form validate-form">
					<div class="wrap-input100 validate-input m-b-26" data-validate="Usuario Es Requerido">
						...
						<input class="input100" type="text" name="username" placeholder="Digite Usuario">
						<span class="focus-input100"></span>
					</div>

					<div class="wrap-input100 validate-input m-b-18" data-validate = "Contraseña Es Requerida">
						<span class="label-input100">Contraseña</span>
						<input class="input100" type="password" name="pass" placeholder="Digite Contraseña">
						<span class="focus-input100"></span>
					</div>
